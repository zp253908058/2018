 ...
 * @author zp
 * @version 1.0
 * @see ShopFirstAddActivity
 * @since 2017/8/23
 */

public class ShopFirstAddActivity extends ToolbarActivity implements DatePickerDialog.OnDateSetListener {
    ...
    public static void startActivity(Context context, int id, String code) {
        ...
        intent.setClass(context, ShopFirstAddActivity.class);
