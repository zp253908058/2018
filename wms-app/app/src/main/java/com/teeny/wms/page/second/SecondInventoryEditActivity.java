 ...
 * @author zp
 * @version 1.0
 * @see SecondInventoryEditActivity
 * @since 2017/8/22
 */

public class SecondInventoryEditActivity extends ToolbarActivity implements RecyclerViewTouchListener.OnItemClickListener, RecyclerViewTouchListener.OnItemLongClickListener, DialogInterface.OnClickListener {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_second_inventory_edit_layout);
    ...
    private void initView() {
        ...
        KeyValueTextView nameView = (KeyValueTextView) findViewById(R.id.second_inventory_edit_name);
        KeyValueTextView codeView = (KeyValueTextView) findViewById(R.id.second_inventory_edit_code);
        KeyValueTextView specificationView = (KeyValueTextView) findViewById(R.id.second_inventory_edit_specification);
        KeyValueTextView allocationView = (KeyValueTextView) findViewById(R.id.second_inventory_edit_allocation);
        KeyValueTextView unitView = (KeyValueTextView) findViewById(R.id.second_inventory_edit_unit);
        KeyValueTextView manufacturerView = (KeyValueTextView) findViewById(R.id.second_inventory_edit_manufacturer);
    ...
    public void onClick(View view) {
        ...
        SecondInventoryRequestEntity entity = new SecondInventoryRequestEntity();
