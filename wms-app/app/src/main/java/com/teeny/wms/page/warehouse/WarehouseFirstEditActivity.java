 ...
 * @author zp
 * @version 1.0
 * @see WarehouseFirstEditActivity
 * @since 2017/8/23
 */

public class WarehouseFirstEditActivity extends ToolbarActivity implements RecyclerViewTouchListener.OnItemClickListener, RecyclerViewTouchListener.OnItemLongClickListener, DialogInterface.OnClickListener {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_warehouse_first_edit_layout);
    ...
    private void initView() {
        ...
        KeyValueTextView nameView = (KeyValueTextView) findViewById(R.id.warehouse_first_edit_name);
        KeyValueTextView codeView = (KeyValueTextView) findViewById(R.id.warehouse_first_edit_code);
        KeyValueTextView specificationView = (KeyValueTextView) findViewById(R.id.warehouse_first_edit_specification);
        KeyValueTextView allocationView = (KeyValueTextView) findViewById(R.id.warehouse_first_edit_allocation);
        KeyValueTextView unitView = (KeyValueTextView) findViewById(R.id.warehouse_first_edit_unit);
        KeyValueTextView manufacturerView = (KeyValueTextView) findViewById(R.id.warehouse_first_edit_manufacturer);
    ...
    public void onClick(View view) {
        ...
        WarehouseInventoryRequestEntity entity = new WarehouseInventoryRequestEntity();
