 ...
 * @author zp
 * @version 1.0
 * @see WarehouseGoodsEntity
 * @since 2017/8/23
 */

public class WarehouseGoodsEntity implements Parcelable {
    ...
    protected WarehouseGoodsEntity(Parcel in) {
        id = in.readInt();
    ...
    public static final Creator<WarehouseGoodsEntity> CREATOR = new Creator<WarehouseGoodsEntity>() {
        @Override
        public WarehouseGoodsEntity createFromParcel(Parcel in) {
            return new WarehouseGoodsEntity(in);
        }

        @Override
        public WarehouseGoodsEntity[] newArray(int size) {
            return new WarehouseGoodsEntity[size];
        }
    };
}
